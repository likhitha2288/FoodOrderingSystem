...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Yummy Treats!</h1>
                    <p>We have the best authentic Desserts, Drinks and Biryanis for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/biryani.avif" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/burger2.avif" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Veg Burger</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/bgcake.avif" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fish2.avif" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fish Curry</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/lemonade.avif" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pasta2.avif" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pasta</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pizza2.avif" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Chicken Pizza</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/salad2.avif" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Mixed Veg Salad</h3>
                                    <p>Price: Rs. 299.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sushi.avif" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sushi(8 Pcs)</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/watermelon.avif" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/chiroast.avif" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Chicken Roast </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/frenchfries.avif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>French Fries</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/panneer2.avif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Kaju Panneer Masala</h3>
                                    <p>Price: Rs. 250.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/noodles.avif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Ramen Noodles</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/roti2.avif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tandoori Roti(4 Pcs) </h3>
                                    <p>Price: Rs. 100.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Orange2.avif" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Orange Juice</h3>
